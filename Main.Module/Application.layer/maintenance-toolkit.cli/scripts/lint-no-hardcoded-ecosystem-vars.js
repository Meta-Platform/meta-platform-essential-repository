...
// voltar a hardcodar uma das 20 variáveis de ecosystem-defaults.json.
...
if (offenders) { console.error(`\nFALHA: ${offenders} arquivo(s), ${total} literal(is) das 20 vars do ecossistema. Remova-os (herança via pkg-exec).`); process.exit(1) }
console.log(`OK: ${files.length} startup-params.json verificados, 0 hardcodes das 20 vars do ecossistema.`)
