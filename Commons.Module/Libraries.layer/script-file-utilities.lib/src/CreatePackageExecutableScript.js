...
const CreatePackageExecutableScript = async ({
    ...
    const RENDER_BINARY_DIR_PATH = join(installationDataDir, ECOSYSTEMDATA_CONF_DIRNAME_ESSENTIAL_BINARY_DIR, packageExecutorBinaryName)
    const scriptContent = buildContentFunction({
        RENDER_BINARY_DIR_PATH,
        RENDER_ECOSYSTEM_DATA_PATH                 : installationDataDir,
